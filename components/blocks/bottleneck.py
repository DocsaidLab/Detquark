...
class BottleneckBlock(nn.Module):
    ...
    This block first expands the channel dimension by `expansion_ratio` via a 1 x 1 convolution,
    ...
    Args:
        ...
        expansion_ratio: Expansion ratio for the hidden channels (default: 0.5).
    ...
    def __init__(
        ...
        self.can_residual = use_shortcut and (in_channels == out_channels)
